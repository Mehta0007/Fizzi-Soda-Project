 ...
 */
export interface AlternatingTextSliceDefaultPrimaryHeadingItem {
  /**
   * Heading field in *AlternatingText → Default → Primary → Text Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: alternating_text.default.primary.heading[].heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
   ...
   * - **Placeholder**: *None*
   * - **API ID Path**: alternating_text.default.primary.heading[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface AlternatingTextSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: alternating_text.default.primary.heading[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  heading: prismic.GroupField<
    Simplify<AlternatingTextSliceDefaultPrimaryHeadingItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      AlternatingTextSlice,
      AlternatingTextSliceDefaultPrimaryHeadingItem,
